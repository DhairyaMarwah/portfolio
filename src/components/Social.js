...
<a className="socialicon twitter" href="" target="_blank" rel="author">
     ...
     <svg className="twitter-icon" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 500 500" enable-background="new 0 0 500 500" >
...
{/* <a className="socialicon dribbble" href="" target="_blank" rel="author">
    <svg className="dribbble-icon" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
    <g>
        <path
...
{/* <img className="instagram-icon" src={InstaImg} alt="" /> */}
